...
readonly SUPPORTED_TUPLES=("darwin-arm64" "linux-x64" "linux-arm64" "windows-x64" "windows-arm64")
...
printf 'release-inventory: started supported-tuples=darwin-arm64,linux-x64,linux-arm64,windows-x64,windows-arm64\n'
